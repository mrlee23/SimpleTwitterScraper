...
declare module '~request~form-data/lib/browser' {
export = FormData;
}
declare module '~request~form-data' {
import main = require('~request~form-data/lib/browser');
export = main;
}
...
export * from '~request~tough-cookie/lib/cookie';
}
...
declare module 'request/index' {
import main = require('~request/index');
export = main;
}
